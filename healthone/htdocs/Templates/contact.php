...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2 class="text-center">| Over onze Vestiging |</h2><br>

            <div class="row">
                <div class="col-md-10 mx-auto d-block">
                    <h6> * Zie hieronder de openingstijden en locatie van sportcenter HealthOne. 
                    ...
                    <br> * Wij zijn dagelijks volgens de openingstijden bereikbaar via 015 257 89 24.</h6>
            ...
            <div class="row">
                <div class="col-sm-10 rounded mx-auto d-block">
                    ...
                    <br>
                    <h5 class="text-center">We zijn gevestigd aan de Zuidhoornseweg 6A, 2635 DJ, Den Hoorn</h5>
                    <br>
                </div>
            </div>
            <hr>
